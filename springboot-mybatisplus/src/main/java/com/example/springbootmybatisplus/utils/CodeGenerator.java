...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //代码生成的目录
        gc.setOutputDir(projectPath + "/product-service/src/main/java");
        //设置作者
        gc.setAuthor("CJW");
        //生成完毕是否打开资源管理器
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://192.168.255.132:3306/gulimall_pms?useUnicode=true&characterEncoding=UTF-8&" +
        ...
        //设置生成包的父路径
        pc.setParent("com.example.productservice");
        //设置生成实体类的包名
        pc.setEntity("DO");
