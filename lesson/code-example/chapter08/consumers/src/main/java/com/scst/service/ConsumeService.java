...
public class ConsumeService {
    ...
    static class ConsumerInGroup0 implements RocketMQListener<Object> {
        @Override
    ...
    static class ConsumerInGroup1 implements RocketMQListener<Order> {
        @Override
    ...
    static class ConsumerInGroup2 implements RocketMQListener<Order> {
        @Override
        public void onMessage(Order o) {
            //消息体（Payload）o为Java对象
            log.info("C2开始消费消息:{}", o);
